...
$(document).ready(function() {
 ...
 $('.loading').fadeIn('slow').html('<font color="green">Sua mensagem foi enviada com sucesso!</font>').delay(3000).fadeOut('slow');



     else

     $('.loading').fadeIn('slow').html('<font color="red">Mensagem não enviada!</font>').delay(3000).fadeOut('slow');
